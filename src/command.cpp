...
void Command::setMode(Mode m) { mMode = m; }
Command::Mode Command::getMode(void) const{ return mMode; }

int Command::getProcNum(){ return mProcInfo->size(); }

vector<ProcInfo> &Command::getProcInfo(void) const{ return *mProcInfo; }
